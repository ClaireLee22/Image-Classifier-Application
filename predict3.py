...
def get_input_args():
    ...
    predict_parser.add_argument('image_path', type=str, default="/home/workspace/flowers/test/28/image_05214.jpg", help='image path')
    # Non-optional checkpoint 
    predict_parser.add_argument('checkpoint', type=str, default="/home/workspace/checkpoint.pth", help='data_dir')
    # Choose top K 
