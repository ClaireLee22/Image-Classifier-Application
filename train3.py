...
def get_input_args():
    ...
    train_parser.add_argument('data_dir', type=str, default="/home/workspace/flowers/", help='data_dir')
    # Choose directory to save checkpoint
    train_parser.add_argument('--save_dir', type=str, default="/home/workspace/checkpoint.pth", help='directory to save checkpoint')
    # Choose model architecture
    train_parser.add_argument('--arch', type=str, default= 'vgg16', help='choose pretrained model')
    # Choose learning rate
    train_parser.add_argument('--learning_rate', type=float, default= 0.01, help='learning rate for traing model')
...
def main():
    ...
    dataloader, image_datasets = load_image()
